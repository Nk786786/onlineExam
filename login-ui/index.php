			...
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="username" placeholder="Enter email" required pattern="[a-zA-Z0-9._%+-]+@gmail\.com$" title="Please enter a valid Gmail address">
                  ...
                  <a href="http://localhost/onlineExam/adminpanel/admin/pages/send_mail.php" >Forgot Password?</a> <!-- Added: Link to forgot password page -->
                </div>
