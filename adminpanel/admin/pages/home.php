            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>
    <h2>Virtual Quiz System Dashboard</h2>
    <div class="page-title-subheading">This is the dashboard for the Virtual Quiz System, which provides an engaging online environment for quizzes.</div>
</div>
                    </div>
