...
<div class="container">
    ...
    <form method="post" action="">
        <div class="form-group">
            <!-- <label for="email">Student Gmail ID:</label> -->
            <input type="email" class="form-control" id="email" name="email" placeholder="Enter Student's gmail id" required pattern="[a-zA-Z0-9._%+-]+@gmail\.com$">
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mail->setFrom('targetfocus2020@gmail.com', 'Admin (VQS)');
